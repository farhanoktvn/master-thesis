...
from models.coarseAlignFeatMatch import CoarseAlign
...
class FeatureExtractor(nn.Module):
    def __init__(self):
        ...
        self.maxpool = nn.Sequential(
            *[nn.MaxPool2d(kernel_size=2, stride=1), Downsample(filt_size=3, stride=2, channels=64)]
        )
...
resumePth = "/Users/farhanoktavian/imperial/thesis/sandbox/rf_regist/weights/MegaDepth_Theta1_Eta001_Grad1_0.774.pth"  ## model for visualization
kernelSize = 7

Transform = utils.Homography
nbPoint = 4
...
# Define Networks
network = {
    "netFeatCoarse": FeatureExtractor(),
    "netCorr": CorrNeigh(kernelSize),
    "netFlowCoarse": NetFlowCoarse(kernelSize),
    "netMatch": NetMatchability(kernelSize),
}
...
msg = "Loaded pretrained model from {}".format(resumePth)
print(msg)
...
def register_image(source, target):
    nbScale = 7
    coarseIter = 10000
    ...
    coarseModel.setSource(source)
    coarseModel.setTarget(target)
